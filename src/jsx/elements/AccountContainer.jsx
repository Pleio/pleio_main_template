...
class AccountContainer extends React.Component {
    ...
    componentWillUnmount() {
        ...
        $('body').removeClass('___open-overlay')
    }

    render() {
        return (
            <Language currentLanguage={this.props.currentLanguage}>
                <div className={classnames({"account-overlay": true, "___is-visible": this.state.isVisible})}>
                    <div className="account">
                        <div className="account__top-bar">
                            <div className="row">
                                <div className="col-xs-6">
                                    <Link to="/" className="account__logo" title="Terug naar de homepage">
                                ...
                                <div className="col-xs-6 end-xs">
                                    <Link to="/"><div className="account__close" data-close-overlay="data-close-overlay"></div></Link>
                                </div>
                            </div>
                        </div>
