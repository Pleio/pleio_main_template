                                            ...
                                            <?php if ($to): ?>
                                                <tr>
                                                    <td valign="top"
                                                        ...
                                                        <?php echo elgg_echo("pleio_main_template:notification:explain"); ?><br />
                                                        <?php echo elgg_echo("pleio_main_template:notification:link", ["{$site->url}notifications/personal/{$to->username}"]); ?>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                            <tr>
