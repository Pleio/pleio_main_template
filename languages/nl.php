...
$dutch = array(
  ...
  'pleio_main_template:menu:learn' => "Leren",
	...
	'pleio_main_template:intro' => 'Pleio is een online samenwerkingsplatform voor alle overheidsorganisaties en bestuurslagen in Nederland. Organisaties kunnen via Pleio onder andere een sociaal intranet, een samenwerkingsomgeving, een community en een kleinere website (deelsite) aanmaken. Het platform is in 2010 ontstaan en heeft momenteel ruim 400.000 gebruikers. Honderden organisaties maken gebruik van Pleio, waaronder de Belastingdienst, Rijksdienst voor Ondernemend Nederland (RVO), het Ministerie van Volksgezondheid, Welzijn en Sport (VWS), de Nederlandse Voedsel- en Warenautoriteit (NVWA), het Samenwerkingsplatform Provincies en vele gemeenten.',
	'pleio_main_template:open_source' => 'Open source en hergebruik',
	'pleio_main_template:open_source:desc' => 'Pleio is uniek binnen de overheid, mede vanwege het open source karakter en het gebruik van open standaarden. Alle ontwikkelde software kan gratis worden hergebruikt door andere overheden. Ook stellen deelsitehouders kennis beschikbaar via Pleio.',
	...
	'pleio_main_template:across_borders:desc' => 'Pleio is opgericht om online samenwerking over de grenzen van losse overheidsorganisaties heen mogelijk te maken. Dankzij Pleio kunnen ambtenaren niet alleen met andere ambtenaren binnen en buiten de eigen overheidsorganisatie samenwerken, maar ook met bedrijven en burgers. Bovendien is het gemakkelijk om deskundigen op specifieke expertisegebieden binnen andere overheidsorganisaties te vinden, waarmee Pleio samenwerking tussen verschillende overheidsorganisaties bevordert.',
	...
	'pleio_main_template:organisation_pleio:desc' => '<p>De organisatie achter het platform is Stichting Pleio. Het bestuur van de stichting behartigt de belangen van deelsitehouders en houdt onder meer toezicht op de financiële zaken. Alle bestuurders zijn ambtenaar en werken bij organisaties die Pleio gebruiken.</p>
	<p>Daarnaast heeft Pleio een beheer- en ontwikkelorganisatie, die voortdurend werkt aan verbeteringen en nieuwe functionaliteiten. Deze organisatie verzorgt daarnaast de helpdesk, organiseert trainingen en ondersteunt beheerders bij het opstarten van een eigen deelsite.</p>',
	'pleio_main_template:help_support' => 'Hulp en ondersteuning',
	'pleio_main_template:help_support:desc' => '<p>De helpdesk is bereikbaar via <a href="mailto:support@pleio.nl">support@pleio.nl</a>. Op <a href="https://mijndeelsite.pleio.nl">mijndeelsite.pleio.nl</a> is informatie te vinden over het inrichten en beheren van een eigen deelsite en delen deelsitebeheerders hun ervaringen. Er worden ook regelmatig bijeenkomsten voor beheerders georganiseerd.</p>',
	'pleio_main_template:request_subsite' => 'Deelsite aanvragen',
	'pleio_main_template:request_subsite:desc' => '<p>(Semi)overheidsorganisaties en zelfstandige bestuursorganen kunnen een eigen deelsite bij Pleio aanvragen.</p>
	<p>Bij het aanmaken van een nieuwe deelsite wordt een eigen adres uitgegeven en krijgt de deelsitebeheerder toegang tot een uitgebreide set van functionaliteiten. Nieuwe deelsitebeheerders kunnen bovendien deelnemen aan startersbijeenkomsten, waarbij in een tot twee dagdelen uitleg wordt gegeven over de praktische werking en inrichting van een eigen deelsite. Elke deelsitehouder draagt zelf de verantwoordelijkheid voor het dagelijkse beheer van de deelsite.</p>
	<p>Het gebruik van het platform is het eerste jaar gratis. Daarna bedragen de jaarlijkse kosten voor een standaard site € 2.250,- excl. BTW per jaar.</p>',
